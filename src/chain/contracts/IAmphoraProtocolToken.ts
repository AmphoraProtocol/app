...
export interface IAmphoraProtocolTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'changeName', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: 'changeSymbol', values: [PromiseOrValue<string>]): string;
...
export interface IAmphoraProtocolToken extends BaseContract {
  ...
  getCurrentVotes(_account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    changeName(_name: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    changeSymbol(_symbol: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    getCurrentVotes(_account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
