...
export interface CurveMasterInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_vaultControllerAddress', values?: undefined): string;
  encodeFunctionData(functionFragment: 'getValueAt', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
  encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
  encodeFunctionData(functionFragment: 'setCurve', values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: '_vaultControllerAddress', data: BytesLike): Result;
...
export interface CurveMaster extends BaseContract {
  ...
  functions: {
    ...
    getValueAt(token_address: string, x_value: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    setCurve(token_address: string, curve_address: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    _curves(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _paused(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    _vaultControllerAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getValueAt(token_address: string, x_value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
