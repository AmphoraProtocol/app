...
export interface ThreeLines0_100Interface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: '_r0' | '_r1' | '_r2' | '_s1' | '_s2' | 'valueAt'): FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'valueAt', values: [BigNumberish]): string;
...
export interface ThreeLines0_100 extends BaseContract {
  ...
  populateTransaction: {
    ...
    valueAt(x_value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
