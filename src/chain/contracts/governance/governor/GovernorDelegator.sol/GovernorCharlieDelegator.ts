...
export interface GovernorCharlieDelegatorInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_setImplementation(address)', values: [string]): string;
  encodeFunctionData(functionFragment: 'implementation', values?: undefined): string;
  encodeFunctionData(functionFragment: 'implementation()', values?: undefined): string;

  decodeFunctionResult(functionFragment: '_setImplementation', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setImplementation(address)', data: BytesLike): Result;
...
export interface GovernorCharlieDelegator extends BaseContract {
  ...
  callStatic: {
    ...
    '_setImplementation(address)'(implementation_: string, overrides?: CallOverrides): Promise<void>;
