...
export interface WaveInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_disableTime', values?: undefined): string;
  encodeFunctionData(functionFragment: '_enableTime', values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: 'getPoints', values: [BigNumberish, BigNumberish, BytesLike[]]): string;
  ...
  encodeFunctionData(functionFragment: 'pointsToken', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: '_disableTime', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_enableTime', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'pointsToken', data: BytesLike): Result;
...
export interface Wave extends BaseContract {
  ...
  filters: {
    'Points(address,uint256)'(from?: string | null, amount?: null): PointsEventFilter;
  ...
  populateTransaction: {
    ...
    redeemed(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
