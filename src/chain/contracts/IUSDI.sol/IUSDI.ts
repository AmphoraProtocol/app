...
export interface IUSDI extends BaseContract {
  ...
  callStatic: {
    ...
    initialize(reserveAddress: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    initialize(reserveAddress: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
