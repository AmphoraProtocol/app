...
import type { GovernorCharlieDelegate, GovernorCharlieDelegateInterface } from '../GovernorCharlieDelegate';
...
type GovernorCharlieDelegateConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class GovernorCharlieDelegate__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<GovernorCharlieDelegate> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorCharlieDelegate {
    return new Contract(address, _abi, signerOrProvider) as GovernorCharlieDelegate;
  }
}
