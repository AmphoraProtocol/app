...
import type { ITokenDelegator, ITokenDelegatorInterface } from '../ITokenDelegator';
...
export class ITokenDelegator__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ITokenDelegator {
