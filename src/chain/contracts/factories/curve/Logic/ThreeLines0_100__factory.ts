...
import type { ThreeLines0_100, ThreeLines0_100Interface } from '../../../curve/Logic/ThreeLines0_100';
...
type ThreeLines0_100ConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: ThreeLines0_100ConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class ThreeLines0_100__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(r0, r1, r2, s1, s2, overrides || {}) as Promise<ThreeLines0_100>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ThreeLines0_100 {
