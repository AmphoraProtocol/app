...
import type { CurveMaster, CurveMasterInterface } from '../../curve/CurveMaster';
...
type CurveMasterConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: CurveMasterConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class CurveMaster__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<CurveMaster> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): CurveMaster {
