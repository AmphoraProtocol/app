...
import type { IGovernorCharlieDelegate, IGovernorCharlieDelegateInterface } from '../IGovernorCharlieDelegate';

const _abi = [
  {
    inputs: [],
    name: 'GovernorCharlie_AlreadyInitialized',
    type: 'error',
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: 'GovernorCharlie_NotGovernor',
    type: 'error',
  },
  {
    inputs: [],
...
export class IGovernorCharlieDelegate__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IGovernorCharlieDelegate {
    return new Contract(address, _abi, signerOrProvider) as IGovernorCharlieDelegate;
  }
}
