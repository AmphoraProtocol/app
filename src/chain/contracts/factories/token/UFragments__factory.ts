...
type UFragmentsConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: UFragmentsConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class UFragments__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<UFragments> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): UFragments {
