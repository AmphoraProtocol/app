...
import type { IGovernorCharlieEvents, IGovernorCharlieEventsInterface } from '../IGovernorCharlieEvents';
...
export class IGovernorCharlieEvents__factory {
  static readonly abi = _abi;
  static createInterface(): IGovernorCharlieEventsInterface {
    return new utils.Interface(_abi) as IGovernorCharlieEventsInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IGovernorCharlieEvents {
    return new Contract(address, _abi, signerOrProvider) as IGovernorCharlieEvents;
  }
}
