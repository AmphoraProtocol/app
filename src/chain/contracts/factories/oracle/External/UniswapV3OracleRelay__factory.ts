...
type UniswapV3OracleRelayConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: UniswapV3OracleRelayConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class UniswapV3OracleRelay__factory extends ContractFactory {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(lookback, pool_address, quote_token_is_token0, mul, div, overrides || {});
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): UniswapV3OracleRelay {
    return new Contract(address, _abi, signerOrProvider) as UniswapV3OracleRelay;
  }
}
