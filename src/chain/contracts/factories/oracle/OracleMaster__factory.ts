...
import type { OracleMaster, OracleMasterInterface } from '../../oracle/OracleMaster';
...
type OracleMasterConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: OracleMasterConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class OracleMaster__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<OracleMaster> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): OracleMaster {
