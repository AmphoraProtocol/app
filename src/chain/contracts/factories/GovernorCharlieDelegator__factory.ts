...
type GovernorCharlieDelegatorConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
...
export class GovernorCharlieDelegator__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorCharlieDelegator {
    return new Contract(address, _abi, signerOrProvider) as GovernorCharlieDelegator;
  }
}
