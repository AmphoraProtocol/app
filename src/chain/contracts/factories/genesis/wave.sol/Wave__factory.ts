...
type WaveConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: WaveConstructorParams): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;
...
export class Wave__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(root, totalReward, floor, enableTime, disableTime, receiver, overrides || {}) as Promise<Wave>;
  }
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(root, totalReward, floor, enableTime, disableTime, receiver, overrides || {});
  }
