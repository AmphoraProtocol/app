...
const isSuperArgs = (xs: UpgradeableBeaconConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class UpgradeableBeacon__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(implementation_, overrides || {}) as Promise<UpgradeableBeacon>;
  }
