...
import type { BeaconProxy, BeaconProxyInterface } from '../../../../_external/ozproxy/beacon/BeaconProxy';
...
const isSuperArgs = (xs: BeaconProxyConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
