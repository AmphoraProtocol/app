...
import type { ProxyAdmin, ProxyAdminInterface } from '../../../../_external/ozproxy/transparent/ProxyAdmin';
...
export class ProxyAdmin__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ProxyAdmin> {
