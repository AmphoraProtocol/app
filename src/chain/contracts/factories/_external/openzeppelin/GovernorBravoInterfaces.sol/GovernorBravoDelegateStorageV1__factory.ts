...
export class GovernorBravoDelegateStorageV1__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<GovernorBravoDelegateStorageV1>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorBravoDelegateStorageV1 {
    return new Contract(address, _abi, signerOrProvider) as GovernorBravoDelegateStorageV1;
  }
}
