...
export class GovernorBravoDelegateStorageV2__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<GovernorBravoDelegateStorageV2>;
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GovernorBravoDelegateStorageV2 {
    return new Contract(address, _abi, signerOrProvider) as GovernorBravoDelegateStorageV2;
  }
}
