...
type GovernorBravoEventsConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: GovernorBravoEventsConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class GovernorBravoEvents__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<GovernorBravoEvents> {
