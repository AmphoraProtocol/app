...
import type { ERC721Upgradeable, ERC721UpgradeableInterface } from '../../../_external/openzeppelin/ERC721Upgradeable';
...
const isSuperArgs = (xs: ERC721UpgradeableConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class ERC721Upgradeable__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ERC721Upgradeable> {
