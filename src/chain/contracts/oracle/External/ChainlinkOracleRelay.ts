...
export interface ChainlinkOracleRelayInterface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: '_divide' | '_feedAddress' | '_multiply' | 'currentValue'): FunctionFragment;

  encodeFunctionData(functionFragment: '_divide', values?: undefined): string;
  encodeFunctionData(functionFragment: '_feedAddress', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: '_feedAddress', data: BytesLike): Result;
