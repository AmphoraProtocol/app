...
export interface UniswapV3OracleRelayInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_poolAddress', values?: undefined): string;
  encodeFunctionData(functionFragment: '_quoteTokenIsToken0', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: '_poolAddress', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_quoteTokenIsToken0', data: BytesLike): Result;
...
export interface UniswapV3OracleRelay extends BaseContract {
  ...
  populateTransaction: {
    ...
    _quoteTokenIsToken0(overrides?: CallOverrides): Promise<PopulatedTransaction>;
