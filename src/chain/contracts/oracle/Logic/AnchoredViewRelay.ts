...
export interface AnchoredViewRelayInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_anchorAddress', values?: undefined): string;
  encodeFunctionData(functionFragment: '_anchorRelay', values?: undefined): string;
  encodeFunctionData(functionFragment: '_mainAddress', values?: undefined): string;
  encodeFunctionData(functionFragment: '_mainRelay', values?: undefined): string;
  encodeFunctionData(functionFragment: '_widthDenominator', values?: undefined): string;
  encodeFunctionData(functionFragment: '_widthNumerator', values?: undefined): string;
  encodeFunctionData(functionFragment: 'currentValue', values?: undefined): string;

  decodeFunctionResult(functionFragment: '_anchorAddress', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_anchorRelay', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_mainAddress', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_mainRelay', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_widthDenominator', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_widthNumerator', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'currentValue', data: BytesLike): Result;
