...
export interface OracleMasterInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getLivePrice', values: [string]): string;
  encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
  encodeFunctionData(functionFragment: 'pauseRelay', values: [string, boolean]): string;
  encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
  encodeFunctionData(functionFragment: 'setRelay', values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: 'getLivePrice', data: BytesLike): Result;
...
export interface OracleMaster extends BaseContract {
  ...
  functions: {
    ...
    getLivePrice(token_address: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    pauseRelay(token_address: string, state: boolean, overrides?: CallOverrides): Promise<void>;

    renounceOwnership(overrides?: CallOverrides): Promise<void>;

    setRelay(token_address: string, relay_address: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    _relays(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getLivePrice(token_address: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
