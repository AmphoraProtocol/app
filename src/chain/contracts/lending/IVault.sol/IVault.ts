...
export interface IVault extends BaseContract {
  ...
  callStatic: {
    ...
    delegateCompLikeTo(compLikeDelegatee: string, compLikeToken: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    tokenBalance(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
