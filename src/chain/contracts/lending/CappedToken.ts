...
export interface CappedToken extends BaseContract {
  ...
  callStatic: {
    ...
    setCap(cap_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    'setCap(uint256)'(cap_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
