...
export interface IGovernorCharlieDelegateInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setEmergencyQuorumVotes",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setEmergencyVotingPeriod",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setOptimisticDelay",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setOptimisticQuorumVotes",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setWhitelistGuardian",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
